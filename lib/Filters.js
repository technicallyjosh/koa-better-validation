...
class Filters {
    ...
    * trim(field, value, separator) {
        const eVal = (separator) ? v.trim(value, separator) : v.trim(value);
    ...
    * ltrim(field, value, separator) {
        const eVal = (separator) ? v.ltrim(value, separator) : v.ltrim(value);
    ...
    * rtrim(field, value, separator) {
        const eVal = (separator) ? v.rtrim(value, separator) : v.rtrim(value);
