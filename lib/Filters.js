...
class Filters {
    ...
    * trim(field, value, separator) {
        if (typeof value === 'string') {
            return (separator) ? v.trim(value, separator) : v.trim(value);
        } else {
    ...
    * ltrim(field, value, separator) {
        if (typeof value === 'string') {
            return (separator) ? v.ltrim(value, separator) : v.ltrim(value);
        } else {
    ...
    * rtrim(field, value, separator) {
        if (typeof value === 'string') {
            return (separator) ? v.rtrim(value, separator) : v.rtrim(value);
        } else {
